...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "UPDATE user SET email='$email', password='$password', f_name='$fathername', f_phone='$fatherphone', m_name='$mothername', m_phone='$motherphone' WHERE id=$id";
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="">ເບີໂທພໍ່</label>
                                <input type="text" class="form-control" name="f_phone" value="<?php echo $row['f_phone']?>">
                            </div>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="">ເບີໂທແມ່</label>
                                <input type="text" class="form-control" name="m_phone" value="<?php echo $row['m_phone']?>">
                            </div>
