...
$sql = "SELECT * FROM user WHERE expenditure IS NOT NULL";
              ...
              <form method="POST" action="insertexpenditure.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="expenditure" class="form-control" id="exampleInputEmail1" required placeholder="ປ້ອນຈຳນວນເງິນ">
                    </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <div class="form-group">
                    <label for="exampleInputPassword1">ລະຫັດຜ່ານ</label>
                    <input type="text" name="ex_reason" class="form-control" id="exampleInputPassword1" required placeholder="ເຫດຜົນ">
                  </div>
                  </div>
