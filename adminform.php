      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <h1 class="text-center">ຟອມAdmin</h1>
            ...
            <table class="table table-striped ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a class="btn btn-warning" href="editadmin.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-edit"></i></a>&nbsp;<a onclick="confirmDelete(<?php echo $row['id'];?>)" class="btn btn-danger"><i class="fas fa-times"></i></a></td>
                </tr>
               <?php } ?>
              </tbody>
            </table>
