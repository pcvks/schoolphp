      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <h1 class="text-center">ຟອມວິຊາ</h1>
              ...
              <form method="POST" action="insertsubject.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="sub_name" class="form-control" id="exampleInputEmail1" required placeholder="ຊື່ວິຊາ">
                    </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <div class="form-group">
          ...
          <div class="col-md-6" style="overflow: auto;">
            <table class="table table-striped ">
              ...
              <tbody>
                ...
                <?php 
                include("./includes/db.php");
                $sql = "SELECT subject.sub_Id,subject.sub_name, user.first_name FROM subject JOIN user ON subject.teacher_id = user.id WHERE user.role = 3";
                $result = mysqli_query($conn, $sql);
                ?>
                ...
                <tr>
                  ...
                  <td><a class="btn btn-warning" href="editsubject.php?sub_Id=<?php echo $row['sub_Id']?>"><i class="fas fa-edit"></i></a>&nbsp;<a onclick="confirmDelete(<?php echo $row['sub_Id'];?>)" class="btn btn-danger"><i class="fas fa-times"></i></a></td>
                </tr>
               <?php } ?>
              </tbody>
            </table>
...
function confirmDelete($id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = 'deletesubject.php?sub_Id=' + $id;
        }
    });
}
</script>
