          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <h3>
                  <?php
                  $sql = "SELECT SUM(income) as income_sum FROM user WHERE role=4";
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <h3>
                  <?php
                  $sql = "SELECT SUM(expenditure) as expen_sum FROM user WHERE role=4";
                  $result = $conn->query($sql);
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>
                  <?php
                  $sql = "SELECT (SUM(income) - SUM(expenditure)) as income_minus_expenditure FROM user WHERE role=4";
                  $result = $conn->query($sql);
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>
                  <?php
                  $sql = "SELECT COUNT(*) as user_count FROM user WHERE role=2";
                  $result = $conn->query($sql);
