              ...
              <form method="POST" action="insert.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="province" class="form-control" id="exampleInputPassword1" required placeholder="ແຂວງ">
                  </div>
                  </div>
                    <div class="row">
                  <div class="form-group">
            ...
            <table class="table table-striped ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a class="btn btn-warning" href="editstudent.php?id=<?php echo $row['id'];?>"><i class="fas fa-edit"></i></a>&nbsp;<a onclick="confirmDelete(<?php echo $row['id'];?>)" class="btn btn-danger"><i class="fas fa-times"></i></a></td>
                </tr>
               <?php } ?>
              </tbody>
            </table>
