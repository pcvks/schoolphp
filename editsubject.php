...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "UPDATE subject SET  sub_name='$sub_name', teacher_id='$teacher_id' WHERE sub_Id=$id";
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <h1 class="text-center">ແກ້ໄຂວິຊາ</h1>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" name="teacher_id" value="<?php echo $row['teacher_id']?>">
                            </div>
